...
extension Defaults.Keys {
    ...
    static let showChargingStausChangedNotification = Key<Bool>(
        "showChargingStausChangedNotification", default: true)
    ...
    static let heatProtectionMagSafeLEDState = Key<MagSafeLEDState>(
        "heatProtectionMagSafeLEDState", default: MagSafeLEDState.blinkOrange)
    // Advanced
